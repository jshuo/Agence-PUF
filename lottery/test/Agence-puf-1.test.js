...
let PUFEntropyOdd=0, PUFEntropyEven=0, MixedPUFEntropyOdd=0, MixedPUFEntropyEven=0 
let previousPUFEntropy, previousMixedPUFEntropy, blockNumber, previousBlockNumber;
...
const eventCallback = (error, result) => {
  ...
  if (previousBlockNumber !== result.blockNumber) {
    ...
    if ( PUFEntropy % 2 === 0 ) {PUFEntropyEven++} 
    else if (PUFEntropy % 2 === 1) {PUFEntropyOdd++} 
    if (MixedPUFEntropy % 2 === 0) {MixedPUFEntropyEven++} 
    else if (MixedPUFEntropy % 2 === 1) {MixedPUFEntropyOdd++} 
    console.log('PUFEntropy is:', PUFEntropy, 'odd count: ', PUFEntropyOdd,  'even count: ', PUFEntropyEven,  
    'MixedPUFEntropy is:', MixedPUFEntropy, 'odd count: ', MixedPUFEntropyOdd,  'even count: ', MixedPUFEntropyEven);
